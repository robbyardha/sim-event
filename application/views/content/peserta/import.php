    ...
    <div class="main">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <?php endif ?>
                <h4>Import Data Master Peserta</h4>
                <div class="row">
                    <div class="col">
                        <p>Masukkan data berupa file excel sesuai dengan format</p>
                        <a href="<?= base_url('peserta/downloadFormat') ?>" class="btn btn-success btn-md me-1"><i class="fa fa-file-excel-o pr-1"></i>Download File Format Excel</a>
                    </div>
                </div>
                <div class="mt-4">
                    <?php echo form_open_multipart('peserta/import', array('name' => 'spreadsheet')); ?>
                    <br>
