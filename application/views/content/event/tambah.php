                        ...
                        <div class="col-md-12">
                            <form method="POST">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nama_event" name="nama_event" placeholder="Wisuda">
                                    <?= form_error('nama_event', '<small class="text-danger">', '</small>') ?>
                                </div>
                                <div class="mb-3">
                                    <label for="deskripsi_event">Deskripsi Event</label>
                                    <textarea name="deskripsi_event" id="deskripsi_event" cols="30" rows="3" class="form-control" placeholder="Wisuda adalah kegiatan yang sakral"></textarea>
                                    <?= form_error('deskripsi_event', '<small class="text-danger">', '</small>') ?>
                                </div>
                                <div class="mb-3">
                                    <label for="tanggal_awal" class="form-label">Tanggal Awal Event</label>
                                    <input type="text" class="form-control flatpickr" name="tanggal_awal" id="tanggal_awal" placeholder="2022-05-24">
                                    <?= form_error('tanggal_awal', '<small class="text-danger">', '</small>') ?>
                                </div>
                                <div class="mb-3">
                                    <label for="tanggal_akhir" class="form-label">Tanggal Akhir Event</label>
                                    <input type="text" class="form-control flatpickr" name="tanggal_akhir" id="tanggal_akhir" placeholder="2022-05-24">
                                    <?= form_error('tanggal_akhir', '<small class="text-danger">', '</small>') ?>
                                </div>
                                <div class="mb-3">
                                    <label for="waktu_mulai" class="form-label">Waktu Mulai Event</label>
                                    <input type="text" class="form-control timepickr" name="waktu_mulai" id="waktu_mulai" placeholder="05:00:00">
                                    <?= form_error('waktu_mulai', '<small class="text-danger">', '</small>') ?>
                                </div>
                                <div class="mb-3">
                                    <label for="waktu_berakhir" class="form-label">Waktu Akhir Event</label>
                                    <input type="text" class="form-control timepickr" name="waktu_berakhir" id="waktu_berakhir" placeholder="05:00:00">
                                    <?= form_error('waktu_berakhir', '<small class="text-danger">', '</small>') ?>
                                </div>
                                <div class="mb-3">
                                    <label for="penyelenggara" class="form-label">Penyelenggara</label>
                                    <input type="text" class="form-control" name="penyelenggara" id="penyelenggara" placeholder="Ardhacodes">
