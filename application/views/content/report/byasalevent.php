<div class="content">
    <div class="main">
        <div class="page-header">
            <h4 class="page-title">Report By Asal</h4>
            <div class="breadcrumb">
                <span class="me-1 text-gray"><i class="feather icon-home"></i></span>
                <div class="breadcrumb-item"><a href="index.html"> Home </a></div>
                <div class="breadcrumb-item"><a href="#"> Report Kehadiran By Asal </a></div>
            </div>
        </div>
        <div class="card">
            <div class="card-body">
                            ...
                            <?php foreach ($event as $ev) : ?>
                                <div class="card bg-info text-dark ms-2 me-2 " style="width: 18rem;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a href="<?= base_url('report/asalevent/')  . $ev['id'] ?>" class="btn btn-danger">LIHAT DATA</a>
                                    </div>
                                </div>
                            <?php endforeach ?>
